function [fig, output_file] = plotStage4Pair(pair, output_file)
%PLOTSTAGE4PAIR Visualize one matched attenuation measurement at f0.
%
...
heading = title(layout, { ...
    sprintf('Stage 4: matched attenuation validation at f_0 = %.1f Hz', ...
        pair.frequency_hz); ...
